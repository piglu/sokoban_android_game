...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _vvvvvvvvvvvv6.PaintOrColorToColor(_props.Get((Object)("Color")));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 32;BA.debugLine="DrawingSubName = \"Draw_\" & style.Replace(\" \", \"\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "Draw_"+_style.replace(" ","");
...
_r = (float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
...
_p.InitializeArc(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY(),_r,(float) (-90),(float) (_progress*2*360));
 }else {
 //BA.debugLineNum = 111;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
_p.InitializeArc(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY(),_r,(float) (-90),(float) (-(1-_progress)*2*360));
 };
 //BA.debugLineNum = 113;BA.debugLine="cvs.ClipPath(p)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.ClipPath(_p);
 //BA.debugLineNum = 114;BA.debugLine="cvs.DrawRect(cvs.TargetRect, clr, True, 0)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.DrawRect(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,__c.True,(float) (0));
 //BA.debugLineNum = 115;BA.debugLine="cvs.RemoveClip";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.RemoveClip();
...
_p.InitializeArc(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY(),_r,(float) (-90),(float) (360-(_progress-0.5)*2*360));
 };
...
_maxr = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getHeight()/(double)2);
 //BA.debugLineNum = 98;BA.debugLine="Dim dx As Int = (cvs.TargetRect.Width - 2dip) / 5";
_dx = (int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getWidth()-__c.DipToCurrent((int) (2)))/(double)5);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.DrawLine((float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY()-_r),(float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY()+_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,(float) (__c.DipToCurrent((int) (4))));
 }
};
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.DrawCircle((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getWidth()-_dotr-_progress*(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX()-__c.DipToCurrent((int) (10)))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY(),(float) (_dotr),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,(int) (255-200*_progress)),__c.True,(float) (0));
...
_cx = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 137;BA.debugLine="Dim cy As Int = cvs.TargetRect.CenterY";
_cy = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY());
 //BA.debugLineNum = 138;BA.debugLine="Dim r As Int = cvs.TargetRect.CenterY - 5dip";
_r = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 139;BA.debugLine="If angle = 0 Then";
if (_angle==0) { 
 //BA.debugLineNum = 140;BA.debugLine="cvs.DrawCircle(cx, cy, r, clr, True, 0)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.DrawCircle((float) (_cx),(float) (_cy),(float) (_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,__c.True,(float) (0));
 }else {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.DrawCircle(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY(),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX()*_progress),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,(int) (255-255*_progress)),__c.True,(float) (0));
 }
};
...
_maxr = (float) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getWidth()/(double)2-__c.DipToCurrent((int) (20)))/(double)2);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.DrawCircle((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterX()+_r*__c.SinD(_alpha)),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY()+_r*__c.CosD(_alpha)),(float) (__c.DipToCurrent((int) (7))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,__c.True,(float) (__c.DipToCurrent((int) (1))));
 }
};
...
_maxr = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getWidth()/(double)2/(double)3-_minr-__c.DipToCurrent((int) (2)));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.DrawCircle((float) (_maxr+_minr+(_minr+_maxr+__c.DipToCurrent((int) (2)))*2*_i),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect().getCenterY(),_r,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,__c.True,(float) (0));
 }
};
...
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
...
//do while
this.state = 4;
while (_myindex==parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3) {
this.state = 3;
if (true) break;
}
if (true) break;
...
_progress = (float) ((parent.__c.DateTime.getNow()-_n)/(double)parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7);
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.ClearRect(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getTargetRect());
 //BA.debugLineNum = 50;BA.debugLine="CallSub2(Me, DrawingSubName, progress)";
parent.__c.CallSubNew2(ba,parent,parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,(Object)(_progress));
 //BA.debugLineNum = 51;BA.debugLine="cvs.Invalidate";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.Invalidate();
...
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(int _c,int _alpha) throws Exception{
