...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.stanks.andsokoban_full.b4xloadingindicator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.stanks.andsokoban_full.b4xloadingindicator.class).invoke(this, new Object[] {null});
        else
...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = 0;
 //BA.debugLineNum = 16;BA.debugLine="Private DrawingSubName As String";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.PaintOrColorToColor(_props.Get((Object)("Color")));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 32;BA.debugLine="DrawingSubName = \"Draw_\" & style.Replace(\" \", \"\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "Draw_"+_style.replace(" ","");
...
_r = (float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
...
_p.InitializeArc(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY(),_r,(float) (-90),(float) (_progress*2*360));
 }else {
 //BA.debugLineNum = 111;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
_p.InitializeArc(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY(),_r,(float) (-90),(float) (-(1-_progress)*2*360));
 };
 //BA.debugLineNum = 113;BA.debugLine="cvs.ClipPath(p)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.ClipPath(_p);
 //BA.debugLineNum = 114;BA.debugLine="cvs.DrawRect(cvs.TargetRect, clr, True, 0)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.DrawRect(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,__c.True,(float) (0));
 //BA.debugLineNum = 115;BA.debugLine="cvs.RemoveClip";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.RemoveClip();
...
_p.InitializeArc(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY(),_r,(float) (-90),(float) (360-(_progress-0.5)*2*360));
 };
...
_maxr = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getHeight()/(double)2);
 //BA.debugLineNum = 98;BA.debugLine="Dim dx As Int = (cvs.TargetRect.Width - 2dip) / 5";
_dx = (int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getWidth()-__c.DipToCurrent((int) (2)))/(double)5);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.DrawLine((float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY()-_r),(float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY()+_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,(float) (__c.DipToCurrent((int) (4))));
 }
};
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.DrawCircle((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getWidth()-_dotr-_progress*(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX()-__c.DipToCurrent((int) (10)))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY(),(float) (_dotr),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,(int) (255-200*_progress)),__c.True,(float) (0));
...
_cx = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 137;BA.debugLine="Dim cy As Int = cvs.TargetRect.CenterY";
_cy = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY());
 //BA.debugLineNum = 138;BA.debugLine="Dim r As Int = cvs.TargetRect.CenterY - 5dip";
_r = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 139;BA.debugLine="If angle = 0 Then";
if (_angle==0) { 
 //BA.debugLineNum = 140;BA.debugLine="cvs.DrawCircle(cx, cy, r, clr, True, 0)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.DrawCircle((float) (_cx),(float) (_cy),(float) (_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,__c.True,(float) (0));
 }else {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.DrawCircle(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY(),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX()*_progress),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,(int) (255-255*_progress)),__c.True,(float) (0));
 }
};
...
_maxr = (float) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getWidth()/(double)2-__c.DipToCurrent((int) (20)))/(double)2);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.DrawCircle((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterX()+_r*__c.SinD(_alpha)),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY()+_r*__c.CosD(_alpha)),(float) (__c.DipToCurrent((int) (7))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,__c.True,(float) (__c.DipToCurrent((int) (1))));
 }
};
...
_maxr = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getWidth()/(double)2/(double)3-_minr-__c.DipToCurrent((int) (2)));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.DrawCircle((float) (_maxr+_minr+(_minr+_maxr+__c.DipToCurrent((int) (2)))*2*_i),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect().getCenterY(),_r,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,__c.True,(float) (0));
 }
};
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.setVisible(__c.False);
...
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
...
public ResumableSub_MainLoop(com.stanks.andsokoban_full.b4xloadingindicator parent) {
this.parent = parent;
}
com.stanks.andsokoban_full.b4xloadingindicator parent;
int _myindex = 0;
long _n = 0L;
float _progress = 0f;
...
//do while
this.state = 4;
while (_myindex==parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3) {
this.state = 3;
if (true) break;
}
if (true) break;
...
_progress = (float) ((parent.__c.DateTime.getNow()-_n)/(double)parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6);
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.ClearRect(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getTargetRect());
 //BA.debugLineNum = 50;BA.debugLine="CallSub2(Me, DrawingSubName, progress)";
parent.__c.CallSubNew2(ba,parent,parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,(Object)(_progress));
 //BA.debugLineNum = 51;BA.debugLine="cvs.Invalidate";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.Invalidate();
...
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(int _c,int _alpha) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.setVisible(__c.True);
