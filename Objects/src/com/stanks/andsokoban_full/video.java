...
public class video extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.stanks.andsokoban_full", "com.stanks.andsokoban_full.video");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.stanks.andsokoban_full", "com.stanks.andsokoban_full.video");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.stanks.andsokoban_full.video", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
anywheresoftware.b4a.phone.Phone _ph = null;
 ...
 //BA.debugLineNum = 92;BA.debugLine="Dim ph As Phone";
_ph = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 94;BA.debugLine="ph.SetScreenOrientation(0)";
...
int _res = 0;
 //BA.debugLineNum = 140;BA.debugLine="Sub delete_Click";
 //BA.debugLineNum = 141;BA.debugLine="Dim res As Int = Msgbox2(\"Really delete selected";
_res = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Really delete selected video?"),BA.ObjectToCharSequence("Warning"),"OK","Cancel","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"upitnik.png").getObject()),mostCurrent.activityBA);
...
public static String  _vv_complete() throws Exception{
 ...
 //BA.debugLineNum = 174;BA.debugLine="Msgbox(\"Playing complete!\", \"Info\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Playing complete!"),BA.ObjectToCharSequence("Info"),mostCurrent.activityBA);
